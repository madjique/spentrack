...
export function PeriodHeader() {
  ...
  return (
    <div className="sticky top-[env(safe-area-inset-top,0px)] z-30 pt-4 px-4 pb-2 md:pt-6 md:px-6">
      <motion.div 
        initial={{ y: -20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ type: "spring", stiffness: 300, damping: 25 }}
        className="flex flex-col sm:flex-row items-center justify-between gap-3 p-1.5 bg-white/40 dark:bg-black/40 backdrop-blur-2xl border border-white/50 dark:border-white/10 rounded-3xl shadow-xl shadow-primary/5 dark:shadow-black/40"
      >
        ...
        <div className="flex items-center justify-between w-full sm:w-auto px-1 gap-2">
          <button 
